...
describe("designConfigToSampleHtml", () => {
  ...
  it("uses minimal nav style by default", () => {
    const html = designConfigToSampleHtml(
      minimalConfig({ layout: { ...minimalConfig().layout, navStyle: "minimal" } })
    );
  ...
  it("uses centered nav style when set", () => {
    const html = designConfigToSampleHtml(
      minimalConfig({ layout: { ...minimalConfig().layout, navStyle: "centered" } })
    );
  ...
  it("uses full nav style when set", () => {
    const html = designConfigToSampleHtml(
      minimalConfig({ layout: { ...minimalConfig().layout, navStyle: "full" } })
    );
