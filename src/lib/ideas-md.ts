...
const FIELD_LABELS: { key: keyof IdeaFields; pattern: RegExp }[] = [
  { key: "problem", pattern: /\*\*Problem:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
  { key: "solution", pattern: /\*\*Solution:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
  { key: "aiIntegration", pattern: /\*\*AI Integration:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
  { key: "userFlow", pattern: /\*\*User Flow:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
  { key: "technicalApproach", pattern: /\*\*Technical Approach:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
  { key: "dependencies", pattern: /\*\*Dependencies:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
  { key: "effort", pattern: /\*\*Effort:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
  { key: "impact", pattern: /\*\*Impact:\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/i },
