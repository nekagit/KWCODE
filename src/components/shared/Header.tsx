...
export const ProjectHeader: React.FC<ProjectHeaderProps> = ({
  ...
  return (
    <div data-shared-ui className={sharedClasses.Header.root}>
      <h2 className={sharedClasses.Header.title}>
        <CategoryIcon className={sharedClasses.Header.titleIcon} /> {categoryName} ({categoryLength})
      </h2>
