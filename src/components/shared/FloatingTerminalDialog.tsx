...
import { TerminalSlot, type TerminalRunData } from "@/components/shared/TerminalSlot";
            ...
            >
                <button
                    ...
                    className={cn(
                        ...
                        running
                            ? "bg-emerald-950/80 border-emerald-500/30 text-emerald-300 shadow-emerald-500/20"
            ...
            >
                <div className="flex items-center gap-2 min-w-0">
                    ...
                    <Terminal className={cn(
                        "size-3.5 shrink-0",
                        running ? "text-emerald-400" : "text-sky-400"
                    )} />
                    <span className="text-[11px] font-medium text-foreground truncate max-w-[260px]">
                        {label}
                    </span>
                    {running && (
                        <span className="flex size-1.5 rounded-full bg-emerald-400 animate-pulse shrink-0" />
                    )}
                </div>
