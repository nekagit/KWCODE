...
/** Project Frontend Tab component. */
...
import {
  parseFrontendSetupJson,
  getDefaultFrontendSetup,
  generateId,
...
export function ProjectFrontendTab({ project, projectId, docsRefreshKey }: ProjectFrontendTabProps) {
  ...
  const fetchData = useCallback(async (getIsCancelled?: () => boolean) => {
    ...
    try {
      ...
      if (!getIsCancelled?.()) {
        ...
        setData(getDefaultFrontendSetup());
      }
    } finally {
  ...
  const save = useCallback(async () => {
    ...
    try {
      ...
      toast.success("Frontend setup saved.");
    } catch (e) {
  ...
  const updateData = useCallback((updater: (prev: FrontendSetupJson) => FrontendSetupJson) => {
    ...
    return (
      <div className="rounded-xl border border-border/40 bg-muted/10 p-6 text-center">
        <p className="text-sm text-muted-foreground">
          Set a repository path for this project to load and save frontend setup from{" "}
    ...
    return (
      <div className="flex items-center justify-center rounded-xl border border-border/40 bg-muted/10 py-24">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-muted-foreground">Loading frontend setup…</p>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-6 pr-4">
          ...
          <SectionCard accentColor="violet">
            ...
            <Textarea
              ...
              placeholder="Short overview of your frontend..."
            />
          </SectionCard>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-[200px]">Type / Location</TableHead>
                    ...
                    <TableRow key={ent.id}>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateData((prev) => ({
                              ...prev,
                              entities: prev.entities.map((x) =>
                                x.id === ent.id ? { ...x, purpose: e.target.value } : x
                              ),
                            }))
                          }
                          placeholder="Purpose"
                      ...
                      <TableCell>
                        <Input
                          ...
                          value={ent.typeLocation}
                          onChange={(e) =>
                            updateData((prev) => ({
                              ...prev,
                              entities: prev.entities.map((x) =>
                                x.id === ent.id ? { ...x, typeLocation: e.target.value } : x
                              ),
                            }))
                          }
            ...
            <Button
              ...
              onClick={() =>
                updateData((prev) => ({
                  ...
                  entities: [
                    ...prev.entities,
                    { id: generateId(), name: "", purpose: "", typeLocation: "" },
                  ],
                }))
              }
            >
                          ...
                          onChange={(e) =>
                            updateData((prev) => ({
                              ...
                              routes: prev.routes.map((x) =>
                                x.id === r.id ? { ...x, page: e.target.value } : x
                              ),
                            }))
                          }
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateData((prev) => ({
                              ...prev,
                              routes: prev.routes.map((x) =>
                                x.id === r.id ? { ...x, route: e.target.value } : x
                              ),
                            }))
                          }
                          placeholder="/path"
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateData((prev) => ({
                              ...prev,
                              routes: prev.routes.map((x) =>
                                x.id === r.id ? { ...x, component: e.target.value } : x
                              ),
                            }))
                          }
            ...
            <Button
              ...
              onClick={() =>
                updateData((prev) => ({
                  ...
                  routes: [
                    ...prev.routes,
                    { id: generateId(), page: "", route: "", component: "" },
                  ],
                }))
              }
            >
