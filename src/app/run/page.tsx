...
/**
 * Run redirect page: /run
 *
 * Dashboard entity link and Run history card "View Run" point to /run. This page
 * redirects to the first active project's Worker (Run) tab, or to /projects with
 * a toast when no project is selected. Aligns with CommandPalette "Go to Run" behaviour.
 */
