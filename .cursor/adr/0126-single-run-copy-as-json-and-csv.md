# ADR 0126 — Single run: Copy as JSON and Copy as CSV to clipboard (duplicate number)

## Status

Superseded by **ADR 0127** — same feature. See `.cursor/adr/0127-single-run-copy-as-json-and-csv.md`.
