# ADR 0262: Dashboard Configuration quick link in entity links (renumbered to 0263)

## Status

Superseded by [ADR 0263](0263-dashboard-configuration-quick-link.md). Kept for reference.
