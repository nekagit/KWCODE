# ADR 0207 — Command palette: Download run history as JSON

**Superseded by [ADR 0208](0208-command-palette-download-run-history-json.md)** (renumbered to avoid collision with 0207-command-palette-download-keyboard-shortcuts).

## Status

Superseded by ADR 0208.
