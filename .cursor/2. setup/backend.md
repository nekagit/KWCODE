...
|-------------|--------------------------|------------------------|
| Ticket      | Work item / task         | id, title, description, status, priority, feature_id; SQLite + `.cursor/planner/tickets.md` |
| Feature     | Milestone grouping tickets | id, title, description, status, ticket_ids; SQLite + `.cursor/planner/features.md` |
...
`.cursor/` in each project repo: `planner/tickets.md`, `planner/features.md`, `planner/kanban-state.json`, `setup/*.md`, `agents/*.md`, `prompts/*.md`.
