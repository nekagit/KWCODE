...
3. **Tech stack summary** – Bullet list or short table (frontend, backend, tooling). Reference .cursor/1. project/frontend-analysis.md and backend-analysis.md when present.
