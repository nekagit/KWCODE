...
### Quality checks (before considering work done)

From the repo root, run:

- **`npm run verify`** — runs unit tests (Vitest), Next.js build, and ESLint in order. Use this before committing or handing off (e.g. after Implement All or night shift tasks).
